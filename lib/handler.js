...
const mode = (!config.WORKTYPE || config.WORKTYPE.toLowerCase().trim() != 'public') ? true : false;
...
module.exports = {cutAudio,cutVideo,toAudio,toPTT,parsedJid,isAdmin,isBotAdmin,getCompo,getDate,parsedJid,PREFIX,mode,extractUrlsFromString,getJson,isIgUrl,getUrl,isNumber,MediaUrls};
