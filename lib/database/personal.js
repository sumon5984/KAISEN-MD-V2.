...
const types = [{'mention': 'object'}, {'areact': 'string'}, {'ban': 'string'}, {'alive': 'string'}, {'login': 'string'}, {'shutoff': 'string'}, {'owner_updt': 'string'}, {'commit_key': 'string'}, {'sticker_cmd': 'object'}, {'plugins': 'object'}, {'toggle': 'object'}];
